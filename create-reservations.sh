...
echo "📝 Creando módulo de Reservations..."

mkdir -p backend/src/modules/reservations
cat > backend/src/modules/reservations/reservations.controller.ts << 'EOF'
...
cat > backend/src/modules/reservations/reservations.routes.ts << 'EOF'
...
echo "✅ Módulo Reservations creado"
